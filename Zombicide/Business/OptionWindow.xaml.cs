...
namespace Zombicide
{
    ...
    public partial class OptionWindow : Window
    {
        public OptionWindow()
        {
            ...
            //List<CharacterDto.CharacterDto> characters = new List<CharacterDto.CharacterDto>();

            //characters.Add(new CharacterDto.CharacterDto()
            //{
            //    IsSelected = false,
            //    Name = "Raoul",
        ...
        private int GetSelectedCharacterNumber()
        {
            ...
            //    foreach (CharacterDto.CharacterDto item in itemsSource)
            //    {
            //        if (item.IsSelected)
            //        {
            //            count++;
